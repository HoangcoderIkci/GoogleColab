...
using namespace std;
const unsigned hsPole = 283; // x^2+x+1
// const unsigned hsPole = 283; // x8 + x4 + x3 + x + 8const unsigned hsPole = 19;                                                        // {\displaystyle x^{8}+x^{7}+x^{6}+x+1}
// unsigned S_BOX[SIZEPOLE] = {0, 13, 2, 12, 6, 9, 4, 11, 3, 5, 8, 15, 7, 10, 14, 1}; //
...
int main()
{
    ...
    vector<unsigned> S_BOX_inv(SIZEPOLE);
