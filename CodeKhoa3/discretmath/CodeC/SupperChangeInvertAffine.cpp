...
void mainProcess()
{
    ...
    for (U32 i = 0; i < MAX_COUNT_CLASS; i++)
    {
        arrRes[i] = (U32 *)malloc(MAX_SIZE / 2 + 5 * sizeof(U32));
    }

    U32 *arrLength = new U32[MAX_SIZE / 2 + 5];
    ...
    // delete count_class;
    delete[] arrLength;
    for (int i = 0; i < MAX_COUNT_CLASS; i++)
    {
